                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="box box-primary">
                            ...
                            <?php
                            echo form_open_multipart(ADMIN . '/Subscription/add_subscription');
                            ?>
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Title</label>
                                            <input type="text" placeholder="Subscription Title" class="form-control" name="title" id="title" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Price</label>
                                            <input type="text" placeholder="Subscription price" class="form-control" name="price" id="price" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Days Count</label>
                                            <input type="text" placeholder="Subscription Days Count" class="form-control" name="days_count" id="days_count" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
